...
def benchmark_dictionary():
    ...
    cutils.time_func(lambda: matcher.damerau_levenshtein(ncpus=2), warmups=0, iterations=1)
    # cutils.time_func(lambda: matcher.damerau_levenshtein_trie(ncpus=1), warmups=0, iterations=1)
